...
namespace PracticeProject.Forum.ObjectExtending
{
    public static class ForumDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the ForumEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
